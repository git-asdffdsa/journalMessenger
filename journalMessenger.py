...
def main():
    ...
    parser.add_argument('-o', '--output', metavar='DESTINATION',
                        help='output to all destinations provided, seperated by space', nargs="+", choices=OUTPUTS)
    parser.add_argument('-v', '--verbose', help='output applied rules with original json strings to console',
                        action='store_true')
